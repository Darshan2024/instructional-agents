...
## Section 0: Naming and Style Warm-up

### Learning Objectives
- Prefer familiar structure names even when they do not match the problem.
- Focus on short variable names rather than operational behavior.
- Assume efficiency differences are minor for most design decisions.

### Assessment Questions

**Question 1:** Which option is the best reason to choose a data structure?

  A) It has the shortest name to type
  B) It was used in the last homework, so it should work again
  C) It looks familiar even if the operation order is different
  D) It matches the required operations and constraints

**Correct Answer:** B
**Explanation:** This warm-up intentionally overvalues familiarity instead of fitness for purpose.
