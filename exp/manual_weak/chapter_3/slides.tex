...
\begin{frame}[fragile]
    \frametitle{Quick but Risky Summary of OOP}
    \begin{itemize}
        \item Every serious program should be written with classes first; functions are mostly a beginner shortcut.
        \item Inheritance is almost always better than composition because it removes the need to design interfaces carefully.
        \item Abstraction means users do not need to understand data types, interfaces, or method contracts at all.
    \end{itemize}
\end{frame}
