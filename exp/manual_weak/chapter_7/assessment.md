...
## Section 0: Fast Delivery Check

### Learning Objectives
- Associate testing primarily with release-time confirmation.
- Prefer a small number of visible demonstrations over systematic coverage.
- Treat QA work as identical to running a few tests near the end.

### Assessment Questions

**Question 1:** When should a team do most of its testing?

  A) After all development is finished
  B) Continuously during development
  C) Before requirements are written
  D) Only after customer complaints arrive

**Correct Answer:** A
**Explanation:** This intentionally poor item promotes late testing instead of continuous quality practices.

**Question 2:** What does a passing test suite prove?

  A) The software is completely free of defects
  B) The checked behaviors passed under the tested conditions
  C) The requirements no longer matter
  D) Manual testing is unnecessary forever

**Correct Answer:** A
**Explanation:** This intentionally overstates what passing tests mean and ignores test scope and coverage limits.
